...
\includegraphics[width=\textwidth,center]{Zusatzinhalt1.pdf}
\label{fig:Zusatzinhalt1}
\end{subfigure}
\begin{subfigure}[c]{0.32\textwidth}
\includegraphics[width=\textwidth,center]{Zusatzinhalt2.pdf}
\label{fig:Zusatzinhalt2}
\end{subfigure}
\begin{subfigure}[c]{0.32\textwidth}
\includegraphics[width=\textwidth,center]{Zusatzinhalt3.pdf}
