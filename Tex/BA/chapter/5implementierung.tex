...
\begin{figure}[h!]
\includegraphics[width=0.95\textwidth,center]{Desktop.png}
\caption{\label{fig:DesktopFinal}Darstellung der finalen Desktop-Version}
\end{figure}

\begin{figure}[h!]
\begin{subfigure}[c]{0.5\textwidth}
\includegraphics[width=0.95\textwidth,center]{Mobil1.png}
\end{subfigure}%
\begin{subfigure}[c]{0.5\textwidth}
\includegraphics[width=0.95\textwidth,center]{Mobil2.png}
\end{subfigure}
