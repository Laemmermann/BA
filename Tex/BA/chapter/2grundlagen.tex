...
Wird beispielsweise eine Gruppenarbeit bei welcher fünf Textabschnitte zusammengefasst werden sollen, dann würde bei einem kooperativen Vorgehen ist jeweils ein Gruppenmitglied für die Zusammenfassung genau eines Textabschnittes verantwortlich sein. Am Ende der Gruppenarbeit würden dann die einzelnen Teilergebnisse zu einem Ergebnis zusammengefasst werden. Bei einem kollaborativen Vorgehen wiederum würden alle Gruppenmitglieder die einzelnen Textabschnitte gemeinsam zusammenfassen. Weitgefasst versteht man unter kooperativem Lernen eine Situation, in der zwei oder mehrere Personen zusammen lernen oder versuchen, zusammen zu lernen \citep{dillenbourg1999collaborative}. Da Kooperation auch einen zentralen Aspekt des zu entwickelnden Moodle-Plugins darstellt, wird nochmals auf die Kooperation beim Lernen sowohl in offline- als auch in online-Lernumgebungen betrachtet.
